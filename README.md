...
[![Category: Smart Home](https://img.shields.io/badge/Category-Smart%20Home-purple)](#)
...
cp -r smart-home/openhue ~/.hermes/skills/smart-home/openhue/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/openhue-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/openhue-skill.git ~/.hermes/skills/smart-home/openhue/
```
...
```text
skill_view(name="smart-home/openhue")
```
...
```text
Use the openhue skill to <describe your specific task here>
```
...
```text
Gunakan skill openhue untuk <deskripsikan tugas spesifik Anda di sini>
```
